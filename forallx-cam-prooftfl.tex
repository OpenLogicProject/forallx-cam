...
Here is a derivation of the second De Morgan rule:
	...
	\end{proof}
Similar demonstrations can be offered explaining how we could derive the third and fourth De Morgan rules. But I will leave these as exercises.

\section{Derivation of Double-negation elimination}
Here is a derivation of the DNE rule, using only the \emph{basic} rules.
\begin{proof}
